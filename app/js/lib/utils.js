/* globals $, Config, angular, setZeroTimeout */
/*!
...
window.checkDragEvent = checkDragEvent;
...
window.getScrollWidth = getScrollWidth;
...
window.onCtrlEnter = onCtrlEnter;
...
window.setFieldSelection = setFieldSelection;
...
window.getFieldSelection = getFieldSelection;
...
window.getRichValueWithCaret = getRichValueWithCaret;
...
window.getRichElementValue = getRichElementValue;
...
window.setRichFocus = setRichFocus;
...
function onContentLoaded (cb) {
  cb = window.onAnimationFrameCallback(cb);
  setZeroTimeout(cb);
}
...
window.safeReplaceObject = safeReplaceObject;
...
window.listMergeSorted = listMergeSorted;
...
window.listUniqSorted = listUniqSorted;
...
window.encodeEntities = encodeEntities;
...
window.calcImageInBox = calcImageInBox;
