/* globals angular, Config, $, setZeroTimeout, tsNow */
...
import { bytesFromHex, sha1BytesSync, bytesToHex, bigStringInt,
    longFromInts, bytesCmp, rsaEncrypt, bytesXor, convertToUint8Array,
    bytesToArrayBuffer, longToBytes, aesDecryptSync, aesEncryptSync, nextRandomInt,
    bufferConcat, bytesFromArrayBuffer, uintToInt } from './bin_utils';
import { SecureRandom, rng_seed_time, BigInteger } from 'jsbn/jsbn_combined';
