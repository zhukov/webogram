...
'use strict';
/* global Config, templateUrl, onContentLoaded, cancelEvent, dT, setZeroTimeout,
        calcImageInBox, getSelectedText,Scroller, setFieldSelection, scrollToNode,
        EmojiTooltip, EmojiPanel, MessageComposer, checkDragEvent, checkClick,
        Image, Clipboard, EmojiHelper, encodeEntities, FB, twttr, gapi, isInDOM,
        hasOnclick, $, angular, tsNow */

import { blobConstruct } from './lib/bin_utils';
import Recorder from 'recorderjs/recorder.min';
