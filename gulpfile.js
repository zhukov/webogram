...
gulp.task('webpack', ['templates'], function () {
  return gulp.src('app/js/boostrap.js')
        .pipe(gulpWebpack(require('./webpack.config.js'), webpack))
        .pipe(gulp.dest('dist/js/'));
});

gulp.task('webpack-crypto', function() {
  return gulp.src('app/js/lib/crypto_worker.js')
        .pipe(gulpWebpack(require('./webpack.crypto.js'), webpack))
        .pipe(gulp.dest('dist/js/lib/'));
});


gulp.task('usemin-index', ['webpack', 'webpack-crypto'], function () {
...
gulp.task('copy', function () {
  return es.concat(
    gulp.src(['app/favicon.ico', 'app/favicon_unread.ico', 'app/manifest.webapp', 'app/manifest.webapp.json', 'app/manifest.json'])
      .pipe(gulp.dest('dist')),
